...
public class Const {
    ...
    public static final String BACKGROUND_URL = "images/background/background.PNG";
    public static final String MENU_BACKGROUND_URL = "images/background/background_menu.PNG";
